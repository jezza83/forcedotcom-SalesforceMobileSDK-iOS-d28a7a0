...
cd "$CURRENT_DIR/Desktop/forcedotcom-SalesforceMobileSDK-iOS-d28a7a0/hybrid/sfdc_build"
ant clean
cd "$CURRENT_DIR/Desktop/forcedotcom-SalesforceMobileSDK-iOS-d28a7a0/native/sfdc_build"
ant clean
...
cd "$CURRENT_DIR/Desktop/forcedotcom-SalesforceMobileSDK-iOS-d28a7a0/native/SampleApps/RestAPIExplorer/sfdc_build"
ant clean
cd "$CURRENT_DIR/Desktop/forcedotcom-SalesforceMobileSDK-iOS-d28a7a0/hybrid/SampleApps/ContactExplorer/sfdc_build"
ant clean
cd "$CURRENT_DIR/Desktop/forcedotcom-SalesforceMobileSDK-iOS-d28a7a0/hybrid/SampleApps/VFConnector/sfdc_build"
ant clean
